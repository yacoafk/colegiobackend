...
import com.colegio.backend.service.EstudiantesService;
...
public class EstudiantesServiceImpl implements EstudiantesService {
    ...
    @Override
    @Transactional
    public EstudiantesRequest registrar(EstudiantesRequest dto) {
    ...
    @Override
    @Transactional
    public EstudiantesRequest modificar(Integer id, EstudiantesRequest dto) {
        ...
        if (dto.getIdTipoDoc() != null) {
            TiposDocumentos td = new TiposDocumentos(); td.setIdTipoDoc(dto.getIdTipoDoc()); existente.setIdTipoDoc(td);
        }
        if (dto.getIdGrado() != null) {
            Grados g = new Grados(); g.setIdGrado(dto.getIdGrado()); existente.setIdGrado(g);
        }
        if (dto.getIdSede() != null) {
            Sedes s = new Sedes(); s.setIdSede(dto.getIdSede()); existente.setIdSede(s);
        }
    ...
    @Override
    public List<CursosRequest> obtenerCursosPorEstudiante(Integer idEstudiante) {
    ...
    private EstudiantesRequest convertirAEntityRequest(Estudiantes e) {
        EstudiantesRequest dto = new EstudiantesRequest();
        // Datos básicos
    ...
    private Estudiantes mappearDtoAEntity(EstudiantesRequest dto) {
        ...
        if(dto.getIdTipoDoc() != null){
            TiposDocumentos td = new TiposDocumentos(); td.setIdTipoDoc(dto.getIdTipoDoc()); e.setIdTipoDoc(td);
        }
        if(dto.getIdGrado() != null){
            Grados g = new Grados(); g.setIdGrado(dto.getIdGrado()); e.setIdGrado(g);
        }
        if(dto.getIdSede() != null){
            Sedes s = new Sedes(); s.setIdSede(dto.getIdSede()); e.setIdSede(s);
        }
        return e;
    }

    private CursosRequest convertirCursoARequest(Cursos curso) {
