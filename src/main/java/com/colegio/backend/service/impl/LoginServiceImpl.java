...
import com.colegio.backend.service.LoginService;
...
public class LoginServiceImpl implements LoginService {
    ...
    @Autowired private PersonalesRepository personalRepo;
    @Autowired private PadresRepository padreRepo;
    @Autowired private EstudiantesRepository estRepo;
