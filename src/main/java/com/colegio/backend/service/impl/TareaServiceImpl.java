...
import com.colegio.backend.dao.TareaRepository;
import com.colegio.backend.dao.ClaseRepository; // Asegúrate de tener este repositorio para validar la clase
...
public class TareaServiceImpl implements TareaService {
    ...
    @Override
    @Transactional
    public TareaRequest registrar(TareaRequest request) {
    ...
    @Override
    @Transactional
    public TareaRequest modificar(Integer id, TareaRequest request) {
    ...
    public List<TareaRequest> listarTareasPorClase(Integer idClase) {
    ...
    private TareaRequest mapearADataTransferObject(Tareas tarea) {
