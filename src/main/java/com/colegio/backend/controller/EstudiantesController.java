...
public class EstudiantesController {
    ...
    @GetMapping
    public ResponseEntity<List<EstudiantesRequest>> listarActivos() {
        return new ResponseEntity<>(service.listarActivos(), HttpStatus.OK);
    }

    @GetMapping("/todos")
    public ResponseEntity<List<EstudiantesRequest>> listarTodos() {
        return new ResponseEntity<>(service.listarTodos(), HttpStatus.OK);
    }

    @GetMapping("/{id}")
    public ResponseEntity<EstudiantesRequest> obtenerPorId(@PathVariable("id") Integer id) {
        return new ResponseEntity<>(service.obtenerPorId(id), HttpStatus.OK);
    }

    @PostMapping("/registrar")
    public ResponseEntity<EstudiantesRequest> registrar(@RequestBody EstudiantesRequest dto) {
        return new ResponseEntity<>(service.registrar(dto), HttpStatus.CREATED);
    }

    @PutMapping("/modificar/{id}")
    public ResponseEntity<EstudiantesRequest> modificar(@PathVariable("id") Integer id, @RequestBody EstudiantesRequest dto) {
    ...
    public ResponseEntity<List<CursosRequest>> obtenerCursos(@PathVariable Integer id) {

        List<CursosRequest> cursos = service.obtenerCursosPorEstudiante(id);
